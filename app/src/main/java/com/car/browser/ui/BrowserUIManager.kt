...
import com.car.browser.model.QuickActionButtonPosition
...
class BrowserUIManager(
    ...
    fun applyQuickActionButtonPreferences() {
        ...
        // Ensure tint is applied correctly after changing resource
        val onPrimary = androidx.core.content.ContextCompat.getColor(activity, R.color.white)
        val primary = androidx.core.content.ContextCompat.getColor(activity, R.color.theme_primary)
        val colorStateListOnPrimary = android.content.res.ColorStateList.valueOf(onPrimary)
        val colorStateListPrimary = android.content.res.ColorStateList.valueOf(primary)
        
        binding.menuFab.imageTintList = colorStateListOnPrimary
        binding.menuFab.backgroundTintList = colorStateListPrimary
        binding.menuFab.supportImageTintList = colorStateListOnPrimary
        binding.menuFab.supportBackgroundTintList = colorStateListPrimary
